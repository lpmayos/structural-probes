...
def structural_probing(seed, probe_name, ptb_path, probes_input_paths, parse_distance_yaml, parse_depth_yaml, models_path, checkpoints_path, checkpoints_list, bert_model, model_to_load):
    ...
    for checkpoint in checkpoints_list:
        ...
        checkpoint_path = models_path + checkpoints_path + '/checkpoint-' + checkpoint
...
if __name__ == '__main__':
    ...
    parser.add_argument("--models_path", default=None, type=str, required=True, help="/home/lpmayos/hd/code/transformers/lpmayos_experiments/bert_base_cased_finetuned_glue/run1")
    parser.add_argument("--checkpoints_path", default=None, type=str, required=True, help="/results_glue/MRPC")
    ...
    structural_probing(args.seed, args.probe_name, args.ptb_path, args.probes_input_paths, args.parse_distance_yaml, args.parse_depth_yaml, args.models_path, args.checkpoints_path, args.checkpoints, args.bert_type, args.model_to_load)
