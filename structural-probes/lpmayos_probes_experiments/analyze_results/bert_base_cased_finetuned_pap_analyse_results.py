...
def analyse_results(probe_name, models_path, runs_list, output_file):
    ...
    for run in runs_list:
        ...
        for checkpoint in run_results:
            ...
            checkpoint_name = int(checkpoint_name.split('-')[1])
            ...
            if '/' in checkpoint:
                ...
                run_results[checkpoint_name]['parse-depth'] = {'dev.root_acc': None,
                                                          'dev.spearmanr-5_50-mean': None}
                run_results[checkpoint_name]['parse-distance'] = {'dev.spearmanr-5_50-mean': None,
                                                             'dev.uuas': None}
                ...
                if os.path.exists(dev_root_acc_file):
                    with open(dev_root_acc_file) as file:
                        ...
                        run_results[checkpoint_name]['parse-depth']['dev.root_acc'] = float(result)
                else:
                ...
                if os.path.exists(dev_spearmanr_file):
                    with open(dev_spearmanr_file) as file:
                        ...
                        run_results[checkpoint_name]['parse-depth']['dev.spearmanr-5_50-mean'] = float(result)
                else:
                ...
                if os.path.exists(dev_uuas_file):
                    with open(dev_uuas_file) as file:
                        ...
                        run_results[checkpoint_name]['parse-distance']['dev.uuas'] = float(result)
                else:
                ...
                if os.path.exists(dev_spearman_file):
                    with open(dev_spearman_file) as file:
                        ...
                        run_results[checkpoint_name]['parse-distance']['dev.spearmanr-5_50-mean'] = float(result)
                else:
