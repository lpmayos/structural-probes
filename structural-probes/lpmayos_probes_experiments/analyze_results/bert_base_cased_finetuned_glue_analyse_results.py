...
def analyse_results(probe_name, models_path, runs_list, output_file, goal_task_name):
    """
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument("--task_name", default=None, type=str, required=True, help="MRPC or QQP")

    args = parser.parse_args()
    analyse_results(args.probe_name, args.models_path, args.runs, args.output_file, args.task_name)
